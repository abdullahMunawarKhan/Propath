...
function Login() {
 ...
 const handleResetPassword = async () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-tr from-[#8ec5fc] via-[#e0c3fc] to-[#f9f3f3] p-6">
      ...
      <div className="z-10 bg-white/40 backdrop-blur-md border border-white/30 rounded-2xl shadow-xl px-10 py-6 flex items-center space-x-8 mb-10">
        <video src="/logo.mp4" autoPlay loop muted playsInline className="h-24 w-24 rounded-full shadow-lg" />
        <h1 className="text-5xl font-extrabold text-purple-800 tracking-wider">ProPath</h1>
      </div>

      {/* Login Form */}
      <div className="z-10 w-full max-w-xl bg-white/30 backdrop-blur-xl border border-white/40 shadow-2xl rounded-3xl p-10 space-y-6">
        ...
        <div className="w-full relative">
          <input
            ...
            className="w-full px-4 py-3 rounded-full bg-white/70 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 pr-12 transition"
            value={password}
