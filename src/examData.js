const examData = [
  ...
  },
  {
    ...
    syllabus: 'GS Papers, Essay, Optional Subject',
    resources: 'NCERTs, Vision IAS, ForumIAS, Insights'
  },
  {
    name: 'NDA',
    domains:['UPSC','NDA'],
    ...
    syllabus: 'Maths, English, General Knowledge',
    resources: 'Official Website, Pathfinder Book, YouTube Lectures'
  },
  {
    name: 'Bank PO (IBPS/SBI)',
    eligibility: 'Graduate in any discipline',
    outcome: 'Probationary Officer in Banks',
    pattern: 'Prelims + Mains + Interview',
    syllabus: 'Quant, Reasoning, English, Banking Awareness',
